...
setup() {
    ...
    export AGENT_MODEL=""
    export AGENT_MODEL_TRIAGE=""
    export AGENT_MODEL_IMPLEMENT=""
    export AGENT_MODEL_REVIEW=""
    export AGENT_MODEL_ADVERSARIAL_PLAN=""
    export AGENT_MODEL_POST_IMPL_REVIEW=""
    export AGENT_MODEL_POST_IMPL_RETRY=""
